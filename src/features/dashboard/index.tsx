            ...
            <div className='grid gap-4 sm:grid-cols-2 lg:grid-cols-4'>
              <Card>
                ...
                <CardContent>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    {t('dashboard.overview.fromLastMonth', { value: '+20.1%' })}
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                  <CardTitle className='text-sm font-medium'>
                    {t('dashboard.overview.subscriptions')}
                  </CardTitle>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 24 24'
              ...
              <Card>
                ...
                <CardContent>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    {t('dashboard.overview.fromLastMonth', { value: '+19%' })}
                  </p>
                </CardContent>
              </Card>
              <Card>
                <CardHeader className='flex flex-row items-center justify-between space-y-0 pb-2'>
                  <CardTitle className='text-sm font-medium'>
                    {t('dashboard.overview.activeNow')}
                  </CardTitle>
                  <svg
                    xmlns='http://www.w3.org/2000/svg'
                    viewBox='0 0 24 24'
                ...
                <CardContent>
                  ...
                  <p className='text-xs text-muted-foreground'>
                    {t('dashboard.overview.sinceLastHour', { value: '+201' })}
                  </p>
                </CardContent>
              </Card>
            </div>
