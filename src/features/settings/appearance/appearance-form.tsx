    ...
    <Form {...form}>
      <form onSubmit={form.handleSubmit(onSubmit)} className='space-y-8'>
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('settingsPage.appearance.fontLabel')}</FormLabel>
              ...
              <FormDescription className='font-manrope'>
                {t('settingsPage.appearance.fontDescription')}
              </FormDescription>
              <FormMessage />
            </FormItem>
          )}
        ...
        <FormField
          ...
          render={({ field }) => (
            <FormItem>
              <FormLabel>{t('settingsPage.appearance.themeLabel')}</FormLabel>
              <FormDescription>
                {t('settingsPage.appearance.themeDescription')}
              </FormDescription>
              <FormMessage />
              <RadioGroup
        ...
        <Button type='submit'>{t('settingsPage.appearance.submit')}</Button>
      </form>
    </Form>
  )
}
